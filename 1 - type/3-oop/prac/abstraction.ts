{
    ...
    // 혹은 임의로 지정
    class CoffeeMachine implements CoffeeMaker, CommerCialCoffeeMaker { // 이 class는 CoffeeMaker 인터페이스를 따라가는 아이
    ...
    const maker: CoffeeMachine = CoffeeMachine.makeMachine(32);
    // 동일한 커피 머신이여도 interface가 달라 쓸 수 있는 함수가 다름
